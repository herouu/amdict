...
@Slf4j
public class InsertColinsDb extends BaseDao {


    private static final int size = 100;
    private static final String OPT_DIR = "C:\\Users\\86138\\IdeaProjects\\dict\\cobuild";
    private static final String tableName = "cobuild";
